...
parser.add_argument(
    "command", help="Setup for the SCE tool to run " + "(setup, run, presubmit, etc.)"
)
parser.add_argument(
    "--project", "-p", nargs="+", help="Project to run presubmit checks for."
)
parser.add_argument("--proto", nargs=1, help="The language(s) to generate proto code.")
parser.add_argument(
    "--language", nargs="+", help="The language(s) to generate proto code."
)
parser.add_argument("--service", "-s", nargs="*", help="SCE Service name")
